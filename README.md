...
- Screencast das histórias finais (com URL visível durante todo o vídeo): https://youtu.be/s_DXP87hk8M 
- Screencast dos testes E2E (execução do `npm run cypress:run`)/Screencast do CI/CD (build + testes + deploy automatizado): https://youtu.be/XOkIT6Zml3E 
